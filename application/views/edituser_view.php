...
<script>
('.gen'+'<?php echo $userinfo[0]['gender']; ?>').prop('selected',true);  
document.getElementById('gen'+'<?php echo $userinfo[0]['gender']; ?>').style.color='red';  
...
<div class="mi">
	...
	<div class="ad_hd fright">
		...
		<form id="frmsubm" name="frmsubm" onsubmit="return validate_user()" action="<?php httpIndex() ?>admin/edit_users/<?php  echo $userinfo[0]['user_id']  ?>" method="post">
			<div class="sngl_row">
				<div class="col-6 hf_sec_l">
					...
					<div class="fld_o_a">
						<input id="full-name" value="<?php echo $userinfo[0]['full_name'] ?>" name="full_name" type="text"/>
					</div>
				</div>
				<div class="col-6 hf_sec_r">
					...
					<div class="fld_o_a">
						<input id="username" value="<?php echo $userinfo[0]['username']?>" name="username" type="text"/>
					</div>
				</div>
			</div>
				...
				<div class="col-6 hf_sec_l">
					...
					<div class="fld_o_a edit">
						<select name="gender" class="gen">
							<option id="gen1" value="1">Male</option>
							<option id="gen2" value="2">Female</option>
						</select>
					</div>					
				</div>
				<div class="col-6 hf_sec_r">
					...
					<div class="fld_o_a">
						<input id="phone" value ="<?php echo $userinfo[0]['phone'] ?>" name="phone" type="text"/>
					</div>
				</div>
			</div>
