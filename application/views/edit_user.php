...
<script>
	...
	$(document).ready(function()	{
		$('#gen'+<?php echo $user_details['gender'] ?>).prop('selected',true);
		$("#privilege option[value='<?php echo $user_details['privilege'] ?>']").prop('selected',true);
		$("#ip_addr option[value='<?php echo $user_details['ip_id'] ?>']").prop('selected',true);
	});
</script>
<div class="mo">
<div class="mi">
